    ...
    <div style={{ display: "flex", justifyContent: "center", alignItems: "center", minHeight: "70vh" }}>
      ...
      >
        <div style={{ textAlign: "center" }}>
          <h1 style={{ fontSize: "2rem", marginBottom: "0.5rem" }}>Join TeamConnect</h1>
          <p style={{ color: "var(--text-secondary)" }}>Create an account to start building</p>
        </div>
        ...
        <p style={{ textAlign: "center", color: "var(--text-secondary)" }}>
          Already have an account? <Link href="/login" style={{ color: "var(--neon-accent)", fontWeight: "600" }}>Sign in here</Link>
        </p>
      </motion.div>
    </div>
  );
